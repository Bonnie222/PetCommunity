...
-- ----------------------------
BEGIN;
INSERT INTO `actsigns` VALUES ('8', '1', '5'), ('9', '1', '4');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `petshow` VALUES ('1', '#技能大比拼#厉害厉害，技能大王', '[{\"fileUrl\":\"src/assets/dbimages/picture-1520581889220.jpg\",\"fileName\":\"79f0f736afc379314a650b4eeac4b74543a91143.jpg\"}]', '2', '1', '2018-03-09 15:51:29');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `relation` VALUES ('2', '1', '3'), ('19', '3', '2');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `user` VALUES ('1', '13437851632', '测试修改', '123456', '170116131212', '2', '656442@qq.com', '1995-03-01', '{\"fileUrl\":\"src/assets/dbimages/avatar-1518423502925.jpg\",\"fileName\":\"u=2171073523,1991282945&fm=27&gp=0.jpg\"}', null, '11', '5', null, null, '辽宁省 丹东市', '0', '0'), ('2', '13189233139', 'bbb', '123456', null, null, null, null, null, null, null, null, null, null, null, '0', '1'), ('3', '13189233129', 'ccc', '123456', '2018122161618', '2', null, null, null, null, null, null, '111', '111', null, '1', '0');
COMMIT;
...
CREATE TRIGGER `tri_updateUserRelation1` AFTER INSERT ON `relation` FOR EACH ROW BEGIN
 DECLARE attSum INT;
 DECLARE fanSum INT;
 SET attSum = (SELECT userAttentions FROM user WHERE id = new.fromUserId);
 SET fanSum = (SELECT userFans FROM user WHERE id = new.toUserId);
 UPDATE user SET userAttentions = attSum+1 WHERE id = new.fromUserId;
 UPDATE user SET  userFans = fanSum+1 WHERE id = new.toUserId;
END
;;
DELIMITER ;
