...
-- ----------------------------
BEGIN;
INSERT INTO `article` VALUES ('1', '猫狗绝育，利大于弊', null, '<p>&nbsp;&nbsp在这个春意萌发、春心萌动的时节，毛开始叫春，狗开始骚动，是时候谈谈这个问题了：要不要给爱宠做绝育手术？<p/>\r\n<p> &nbsp&nbsp据不完全统计，一直母狗和其后代，六年内约能生出6.7万只小狗。一只母猫和其后代，七年内约能繁殖37只小猫！这个数字远远超过能照顾它们的家庭的数量。</p>\r\n<p>&nbsp&nbsp那些没人要的猫狗，只能流浪街头，挣扎度日。有人收养的猫狗，也将面临考验，发情时骚动不安，乱拉乱尿乱叫，甚至是会在追逐异性的过程中走失，或是患上生殖系统疾病，痛苦死去。倘若你给他们做了绝育手术，这些问题将迎刃而解。</p>', '1', '0', '2018-04-16 16:05:50', '爱宠'), ('2', '猫狗说说说', null, '啊实打实大苏打', '1', '0', '2018-04-13 18:01:43', '爱宠');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `collected` VALUES ('7', '2', '1', '2018-04-18 18:19:49'), ('8', '1', '1', '2018-04-18 18:19:55');
COMMIT;
