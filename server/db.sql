...
`userAttentions`  int(11) NULL DEFAULT 0 ,
`userFans`  int(11) NULL DEFAULT 0 ,
PRIMARY KEY (`id`)
)
ENGINE=InnoDB
DEFAULT CHARACTER SET=utf8 COLLATE=utf8_general_ci
...
-- ----------------------------
BEGIN;
INSERT INTO `user` VALUES ('0', '13189233129', 'ccc', '123456', '2018122161618', '2', null, null, null, null, null, null, '111', '111', null, '0', '0'), ('1', '13437851632', '测试修改', '123456', '170116131212', '2', '656442@qq.com', '1995-03-01', '{\"fileUrl\":\"src/assets/dbimages/avatar-1518423502925.jpg\",\"fileName\":\"u=2171073523,1991282945&fm=27&gp=0.jpg\"}', null, '11', '5', null, null, '辽宁省 丹东市', '0', '0'), ('2', '13189233139', 'bbb', '123456', null, null, null, null, null, null, null, null, null, null, null, '0', '0');
COMMIT;
